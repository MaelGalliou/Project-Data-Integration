...
# engine = create_engine('mysql+pymysql://avnadmin:AVNS_KWg-ilnmRw4cWXWyZia@mysql-dataint-project-2k25-sachoun32-b208.g.aivencloud.com:14062/data-warehouse?ssl-mode=REQUIRED')
...
fact_trips.columns = ['vendor_id', 'tpep_pickup_datetime', 'tpep_dropoff_datetime', 'passenger_count',
                      'trip_distance', 'rate_code_id', 'pickup_location_id', 'payment_type_id',
                      'fare_amount', 'extra', 'mta_tax', 'tip_amount', 'tolls_amount',
                      'improvement_surcharge', 'congestion_surcharge', 'total_amount']
